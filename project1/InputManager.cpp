...
void input_manager(string input, List* citizen_list, List* virus_bloom_list, List* virus_skip_list, int bloom_size)
{
    ...
    if(value == "/vaccineStatusBloom")
    {
        vaccineStatusBloom(c_input, citizen_list, virus_bloom_list);
    }
    else if(value == "/vaccineStatus")
    {
        vaccineStatus(c_input, citizen_list, virus_skip_list);        
    }
    else if(value == "/populationStatus")
    {
        populationStatus(c_input, virus_skip_list);
    }
    else if(value == "/popStatusByAge")
    {
        popStatusByAge(c_input, virus_skip_list);
    }
    else if(value == "/insertCitizenRecord")
    {
        insertCitizenRecord(c_input, citizen_list, virus_bloom_list, virus_skip_list, bloom_size);
    }
    else if(value == "/vaccinateNow")
    {
        vaccinateNow(c_input, citizen_list, virus_bloom_list, virus_skip_list, bloom_size);
    }
    else if(value == "/list-nonVaccinated-Persons")
    {
       list_nonVaccinated_Persons(c_input, citizen_list, virus_skip_list);
    }
    else 
    {
